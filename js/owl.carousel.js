! function(h, i, n, o) {
    ...
    l.Defaults = {
        ...
        return this.settings.freeDrag || h.each(r, h.proxy(function(t, e) {
            return e - 30 < i && i < e + 30 ? n = t : this.op(i, "<", e) && this.op(i, ">", r[t + 1] || e - o) && (n = "left" === s ? t + 1 : t), -1 === n
        ...
        return !h.isNumeric(t) || i < 1 ? t = o : (t < 0 || i + s <= t) && (t = ((t - s / 2) % i + i) % i + s / 2), t
...
function(s) {
    ...
    e.Defaults = {
        ...
        heights = [], maxheight = 0, s.each(i, function(t, e) {
            heights.push(s(e).height())
...
function(c, e) {
    ...
    i.Defaults = {
        ...
        "youtube" === t.type ? (n = "http://img.youtube.com/vi/" + t.id + "/hqdefault.jpg", i(n)) : "vimeo" === t.type && c.ajax({
            type: "GET",
...
function(i, s, n) {
    ...
    e.Defaults = {
        ...
        this._paused = !1, this._core.is("rotating") || (this._core.enter("rotating"), this._interval = s.setInterval(i.proxy(function() {
            this._paused || this._core.is("busy") || this._core.is("interacting") || n.hidden || this._core.next(e || this._core.settings.autoplaySpeed)
        }, this), t || this._core.settings.autoplayTimeout))
    }, e.prototype.stop = function() {
        this._core.is("rotating") && (s.clearInterval(this._interval), this._core.leave("rotating"))
    ...
    var e = function(t) {
        this._core = t, this._hashes = {}, this.$element = this._core.$element, this._handlers = {
            ...
            "prepared.owl.carousel": s.proxy(function(t) {
                if (t.namespace) {
                    var e = s(t.content).find("[data-hash]").andSelf("[data-hash]").attr("data-hash");
                    if (!e) return;
