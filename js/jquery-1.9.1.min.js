! function(h, N) {
    ...
    function r(e) {
        !g.addEventListener && "load" !== e.type && "complete" !== g.readyState || (H(), ye.ready())
    }
    var i, n, y = typeof N,
        g = h.document,
        e = h.location,
    ...
    ye.fn = ye.prototype = {
        ...
        init: function(e, t, n) {
            var r, i;
            if (!e) return this;
            if ("string" != typeof e) return e.nodeType ? (this.context = this[0] = e, this.length = 1, this) : ye.isFunction(e) ? n.ready(e) : (e.selector !== N && (this.selector = e.selector, this.context = e.context), ye.makeArray(e, this));
            if (!(r = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && 3 <= e.length ? [null, e, null] : w.exec(e)) || !r[1] && t) return !t || t.jquery ? (t || n).find(e) : this.constructor(t).find(e);
            if (r[1]) {
                if (t = t instanceof ye ? t[0] : t, ye.merge(this, ye.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : g, !0)), k.test(r[1]) && ye.isPlainObject(t))
        ...
        for ("boolean" == typeof a && (l = a, a = arguments[1] || {}, s = 2), "object" == typeof a || ye.isFunction(a) || (a = {}), u === s && (a = this, --s); s < u; s++)
            if (null != (i = arguments[s]))
                for (r in i) e = a[r], a !== (n = i[r]) && (l && n && (ye.isPlainObject(n) || (t = ye.isArray(n))) ? (o = t ? (t = !1, e && ye.isArray(e) ? e : []) : e && ye.isPlainObject(e) ? e : {}, a[r] = ye.extend(l, o, n)) : n !== N && (a[r] = n));
        return a
    }, ye.extend({
        noConflict: function(e) {
            return h.$ === ye && (h.$ = a), e && h.jQuery === ye && (h.jQuery = o), ye
        },
        isReady: !1,
        readyWait: 1,
        ...
        ready: function(e) {
            if (!0 === e ? !--ye.readyWait : !ye.isReady) {
                if (!g.body) return setTimeout(ye.ready);
                (ye.isReady = !0) !== e && 0 < --ye.readyWait || (i.resolveWith(g, [ye]), ye.fn.trigger && ye(g).trigger("ready").off("ready"))
            }
        },
        ...
        parseJSON: function(e) {
            return h.JSON && h.JSON.parse ? h.JSON.parse(e) : null === e ? e : "string" == typeof e && ((e = ye.trim(e)) && E.test(e.replace(A, "@").replace(j, "]").replace(S, ""))) ? Function("return " + e)() : (ye.error("Invalid JSON: " + e), N)
        },
        parseXML: function(e) {
            var t;
            if (!e || "string" != typeof e) return null;
        ...
        camelCase: function(e) {
            return e.replace(D, "ms-").replace(L, t)
        },
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (q(Object(e)) ? ye.merge(n, "string" == typeof e ? [e] : e) : l.call(n, e)), n
        },
        ...
        proxy: function(e, t) {
            var n, r, i;
            return "string" == typeof t && (i = e[t], t = e, e = i), ye.isFunction(e) ? (n = c.call(arguments, 2), (r = function() {
        ...
        access: function(e, t, n, r, i, o, a) {
            ...
            else if (r !== N && (i = !0, ye.isFunction(r) || (a = !0), l && (t = a ? (t.call(e, r), null) : (l = t, function(e, t, n) {
        ...
        if (!i)
            if (i = ye.Deferred(), "complete" === g.readyState) setTimeout(ye.ready);
    ...
    ye.Callbacks = function(i) {
        var e, n;
        i = "string" == typeof i ? M[i] || (n = M[e = i] = {}, ye.each(e.match(C) || [], function(e, t) {
            n[t] = !0
        }), n) : ye.extend({}, i);
        var r, t, o, a, s, u, l = [],
            c = !i.once && [],
        ...
        when: function(e) {
            ...
            var i, n, r, o = 0,
                a = c.call(arguments),
                s = a.length,
                u = 1 !== s || e && ye.isFunction(e.promise) ? s : 0,
                l = 1 === u ? e : ye.Deferred();
            if (1 < s)
                for (i = Array(s), n = Array(s), r = Array(s); o < s; o++) a[o] && ye.isFunction(a[o].promise) ? a[o].promise().done(t(o, r, a)).fail(l.reject).progress(t(o, n, i)) : --u;
            return u || l.resolveWith(r, a), l.promise()
        }
    }), ye.support = function() {
        var o, e, t, n, r, i, a, s, u, l, c = g.createElement("div");
    ...
    function O(e, t, n, r) {
        if (ye.acceptData(e)) {
            var i, o, a = ye.expando,
                ...
                l = u ? ye.cache : e,
                c = u ? e[a] : e[a] && a;
            if (c && l[c] && (r || l[c].data) || !s || n !== N) return c || (u ? e[a] = c = f.pop() || ye.guid++ : c = a), l[c] || (l[c] = {}, u || (l[c].toJSON = ye.noop)), "object" != typeof t && "function" != typeof t || (r ? l[c] = ye.extend(l[c], t) : l[c].data = ye.extend(l[c].data, t)), i = l[c], r || (i.data || (i.data = {}), i = i.data), n !== N && (i[ye.camelCase(t)] = n), s ? null == (o = i[t]) && (o = i[ye.camelCase(t)]) : o = i, o
        }
    }
        ...
        if (ye.acceptData(e)) {
            ...
            if (s[u]) {
                if (t && (o = n ? s[u] : s[u].data)) {
                    for ((r = 0, i = (t = ye.isArray(t) ? t.concat(ye.map(t, ye.camelCase)) : t in o ? [t] : (t = ye.camelCase(t)) in o ? [t] : t.split(" ")).length); r < i; r++) delete o[t[r]];
                    if (!(n ? R : ye.isEmptyObject)(o)) return
                }(n || (delete s[u].data, R(s[u]))) && (a ? ye.cleanData([e], !0) : ye.support.deleteExpando || s != s.window ? delete s[u] : s[u] = null)
            }
        }
    }
    ...
    function P(e, t, n) {
        if (n === N && 1 === e.nodeType) {
            ...
            if ("string" == typeof(n = e.getAttribute(r))) {
                try {
                    n = "true" === n || "false" !== n && ("null" === n ? null : +n + "" === n ? +n : _.test(n) ? ye.parseJSON(n) : n)
                } catch (e) {}
                ye.data(e, t, n)
            } else n = N
        }
    ...
    ye.extend({
        ...
        hasData: function(e) {
            return !!(e = e.nodeType ? ye.cache[e[ye.expando]] : e[ye.expando]) && !R(e)
        },
        data: function(e, t, n) {
            return O(e, t, n)
        },
        ...
        data: function(t, e) {
            ...
            if (t !== N) return "object" == typeof t ? this.each(function() {
                ...
                return e === N ? i ? P(i, t, ye.data(i, t)) : null : (this.each(function() {
                    ye.data(this, t, e)
                }), N)
            }, null, e, 1 < arguments.length, null, !0);
            if (this.length && (a = ye.data(i), 1 === i.nodeType && !ye._data(i, "parsedAttrs"))) {
                for (n = i.attributes; n.length > o; o++)(r = n[o].name).indexOf("data-") || (r = ye.camelCase(r.slice(5)), P(i, r, a[r]));
        ...
        queue: function(t, n) {
            var e = 2;
            return "string" != typeof t && (n = t, t = "fx", e--), arguments.length < e ? ye.queue(this[0], t) : n === N ? this : this.each(function() {
        ...
        promise: function(e, t) {
            ...
            var r, i = 1,
                ...
                a = this,
                s = this.length;
            for ("string" != typeof e && (t = e, e = N), e = e || "fx"; s--;)(r = ye._data(a[s], e + "queueHooks")) && r.empty && (i++, r.empty.add(n));
    ...
    ye.fn.extend({
        ...
        toggleClass: function(o, a) {
            ...
            return ye.isFunction(o) ? this.each(function(e) {
                ...
                if ("string" == s)
                    for (var e, t = 0, n = ye(this), r = a, i = o.match(C) || []; e = i[t++];) r = u ? r : !n.hasClass(e), n[r ? "addClass" : "removeClass"](e);
                else s !== y && "boolean" != s || (this.className && ye._data(this, "__className__", this.className), this.className = this.className || !1 === o ? "" : ye._data(this, "__className__") || "")
            })
        },
        hasClass: function(e) {
            for (var t = " " + e + " ", n = 0, r = this.length; n < r; n++)
                if (1 === this[n].nodeType && 0 <= (" " + this[n].className + " ").replace(I, " ").indexOf(t)) return !0;
            return !1
        },
        val: function(r) {
            var e, i, o, t = this[0];
            ...
            })) : t ? (i = ye.valHooks[t.type] || ye.valHooks[t.nodeName.toLowerCase()]) && "get" in i && (e = i.get(t, "value")) !== N ? e : "string" == typeof(e = t.value) ? e.replace(z, "") : null == e ? "" : e : void 0
        }
    }), ye.extend({
        valHooks: {
            option: {
        ...
        attr: function(e, t, n) {
            var r, i, o, a = e.nodeType;
            if (e && 3 !== a && 8 !== a && 2 !== a) return typeof e.getAttribute === y ? ye.prop(e, t, n) : ((i = 1 !== a || !ye.isXMLDoc(e)) && (t = t.toLowerCase(), r = ye.attrHooks[t] || (V.test(t) ? $ : W)), n === N ? r && i && "get" in r && null !== (o = r.get(e, t)) ? o : (typeof e.getAttribute !== y && (o = e.getAttribute(t)), null == o ? N : o) : null !== n ? r && i && "set" in r && (o = r.set(e, n, t)) !== N ? o : (e.setAttribute(t, n + ""), n) : (ye.removeAttr(e, t), N))
        },
        removeAttr: function(e, t) {
            var n, r, i = 0,
                o = t && t.match(C);
            if (o && 1 === e.nodeType)
                for (; n = o[i++];) r = ye.propFix[n] || n, V.test(n) ? !J && Y.test(n) ? e[ye.camelCase("default-" + n)] = e[r] = !1 : e[r] = !1 : ye.attr(e, n, ""), e.removeAttribute(J ? n : r)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
        ...
        get: function(e, t) {
            var n = ye.prop(e, t),
                ...
                i = "boolean" == typeof n ? G && J ? null != r : Y.test(t) ? e[ye.camelCase("default-" + t)] : !!r : e.getAttributeNode(t);
            return i && !1 !== i.value ? t.toLowerCase() : N
        },
        set: function(e, t, n) {
            return !1 === t ? ye.removeAttr(e, n) : G && J || !Y.test(n) ? e.setAttribute(!J && ye.propFix[n] || n, n) : e[ye.camelCase("default-" + n)] = e[n] = !0, n
        }
    }, G && J || (ye.attrHooks.value = {
        get: function(e, t) {
            var n = e.getAttributeNode(t);
            return ye.nodeName(e, "input") ? e.defaultValue : n && n.specified ? n.value : N
        },
        set: function(e, t, n) {
            return ye.nodeName(e, "input") ? (e.defaultValue = t, N) : W && W.set(e, t, n)
        }
    }), J || (W = ye.valHooks.button = {
        get: function(e, t) {
            var n = e.getAttributeNode(t);
    ...
    ye.event = {
            ...
            add: function(e, t, n, r, i) {
                ...
                if (m) {
                    for (n.handler && (n = (u = n).handler, i = u.selector), n.guid || (n.guid = ye.guid++), (a = m.events) || (a = m.events = {}), (c = m.handle) || ((c = m.handle = function(e) {
                            return typeof ye === y || e && ye.event.triggered === e.type ? N : ye.event.dispatch.apply(c.elem, arguments)
                        }).elem = e), s = (t = (t || "").match(C) || [""]).length; s--;) d = g = (o = te.exec(t[s]) || [])[1], h = (o[2] || "").split(".").sort(), l = ye.event.special[d] || {}, d = (i ? l.delegateType : l.bindType) || d, l = ye.event.special[d] || {}, f = ye.extend({
                        type: d,
                        origType: g,
                        data: r,
                        handler: n,
            ...
            fix: function(e) {
                ...
                var t, n, r, i = e.type,
                    o = e,
                    a = this.fixHooks[i];
                for (a || (this.fixHooks[i] = a = Z.test(i) ? this.mouseHooks : K.test(i) ? this.keyHooks : {}), r = a.props ? this.props.concat(a.props) : this.props, e = new ye.Event(o), t = r.length; t--;) e[n = r[t]] = o[n];
        ...
        }, ye.removeEvent = g.removeEventListener ? function(e, t, n) {
            e.removeEventListener && e.removeEventListener(t, n, !1)
        } : function(e, t, n) {
            var r = "on" + t;
            e.detachEvent && (typeof e[r] === y && (e[r] = null), e.detachEvent(r, n))
        }, ye.Event = function(e, t) {
            return this instanceof ye.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || !1 === e.returnValue || e.getPreventDefault && e.getPreventDefault() ? ne : re) : this.type = e, t && ye.extend(this, t), this.timeStamp = e && e.timeStamp || ye.now(), this[ye.expando] = !0, N) : new ye.Event(e, t)
        }, ye.Event.prototype = {
            ...
            setup: function() {
                return Q.test(this.nodeName) ? ("checkbox" !== this.type && "radio" !== this.type || (ye.event.add(this, "propertychange._change", function(e) {
                    ...
                    var t = e.target;
                    Q.test(t.nodeName) && !ye._data(t, "changeBubbles") && (ye.event.add(t, "change._change", function(e) {
            ...
            teardown: function() {
                return ye.event.remove(this, "._change"), !Q.test(this.nodeName)
            }
            ...
            off: function(e, t, n) {
                ...
                if ("object" != typeof e) return !1 !== t && "function" != typeof t || (n = t, t = N), !1 === n && (n = re), this.each(function() {
        ...
        function(n, r) {
            var e, T, w, o, t, h, l, N, g, C, i, m, y, a, s, v, c, b = "sizzle" + -new Date,
                x = n.document,
                k = {},
                E = 0,
                f = 0,
            ...
            try {
                L.call(x.documentElement.childNodes, 0)[0].nodeType
            } catch (e) {
                L = function(e) {
            ...
            function re(e, t, n, r) {
                ...
                if ((t ? t.ownerDocument || t : x) !== C && g(t), n = n || [], !e || "string" != typeof e) return n;
                ...
                if (!m && !r) {
                    if (i = U.exec(e))
                        if (a = i[1]) {
                            ...
                            if ((a = i[3]) && k.getByClassName && t.getElementsByClassName) return D.apply(n, L.call(t.getElementsByClassName(a), 0)), n
                        }
                    if (k.qsa && !y.test(e)) {
                        if (c = !0, f = b, p = t, d = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
            ...
            for (e in t = re.isXML = function(e) {
                    ...
                    return u !== C && 9 === u.nodeType && u.documentElement && (i = (C = u).documentElement, m = t(u), k.tagNameNoComments = ne(function(e) {
                        return e.appendChild(u.createComment("")), !e.getElementsByTagName("*").length
                    }), k.attributes = ne(function(e) {
                        e.innerHTML = "<select></select>";
                        var t = typeof e.lastChild.getAttribute("multiple");
                        return "boolean" != t && "string" != t
                    }), k.getByClassName = ne(function(e) {
                        return e.innerHTML = "<div class='hidden e'></div><div class='hidden'></div>", !(!e.getElementsByClassName || !e.getElementsByClassName("e").length) && (e.lastChild.className = "e", 2 === e.getElementsByClassName("e").length)
                    }), k.getByName = ne(function(e) {
                        e.id = b + 0, e.innerHTML = "<a name='" + b + "'></a><div name='" + b + "'></div>", i.insertBefore(e, i.firstChild);
                        var t = u.getElementsByName && u.getElementsByName(b).length === 2 + u.getElementsByName(b + 0).length;
                        return k.getIdNotName = !u.getElementById(b), i.removeChild(e), t
                    ...
                    }, k.getIdNotName ? (w.find.ID = function(e, t) {
                    ...
                    }), w.find.TAG = k.tagNameNoComments ? function(e, t) {
                        ...
                        return r
                    }, w.find.NAME = k.getByName && function(e, t) {
                        return typeof t.getElementsByName != S ? t.getElementsByName(name) : r
                    }, w.find.CLASS = k.getByClassName && function(e, t) {
                        return typeof t.getElementsByClassName == S || m ? r : t.getElementsByClassName(e)
                    }, a = [], y = [":focus"], (k.qsa = Z(u.querySelectorAll)) && (ne(function(e) {
                        e.innerHTML = "<select><option selected=''></option></select>", e.querySelectorAll("[selected]").length || y.push("\\[" + q + "*(?:checked|disabled|ismap|multiple|readonly|selected|value)"), e.querySelectorAll(":checked").length || y.push(":checked")
                    }), ne(function(e) {
                        e.innerHTML = "<input type='hidden' i=''/>", e.querySelectorAll("[i^='']").length && y.push("[*^$]=" + q + "*(?:\"\"|'')"), e.querySelectorAll(":enabled").length || y.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), y.push(",.*:")
                    })), (k.matchesSelector = Z(s = i.matchesSelector || i.mozMatchesSelector || i.webkitMatchesSelector || i.oMatchesSelector || i.msMatchesSelector)) && ne(function(e) {
                        k.disconnectedMatch = s.call(e, "div"), s.call(e, "[s!='']:x"), a.push("!=", O)
                    }), y = RegExp(y.join("|")), a = RegExp(a.join("|")), v = Z(i.contains) || i.compareDocumentPosition ? function(e, t) {
                        ...
                        var n;
                        return e === t ? (l = !0, 0) : (n = t.compareDocumentPosition && e.compareDocumentPosition && e.compareDocumentPosition(t)) ? 1 & n || e.parentNode && 11 === e.parentNode.nodeType ? e === u || v(x, e) ? -1 : t === u || v(x, t) ? 1 : 0 : 4 & n ? -1 : 1 : e.compareDocumentPosition ? -1 : 1
                    } : function(e, t) {
                        var n, r = 0,
                            i = e.parentNode,
                            o = t.parentNode,
                        ...
                        for (; a[r] === s[r];) r++;
                        return r ? ie(a[r], s[r]) : a[r] === x ? -1 : s[r] === x ? 1 : 0
                    }, l = !1, [0, 0].sort(c), k.detectDuplicates = l), C
                }, re.matches = function(e, t) {
                    return re(e, null, null, t)
                }, re.matchesSelector = function(e, t) {
                    if ((e.ownerDocument || e) !== C && g(e), t = t.replace(G, "='$1']"), !(!k.matchesSelector || m || a && a.test(t) || y.test(t))) try {
                        var n = s.call(e, t);
                    ...
                    var n;
                    return (e.ownerDocument || e) !== C && g(e), m || (t = t.toLowerCase()), (n = w.attrHandle[t]) ? n(e) : m || k.attributes ? e.getAttribute(t) : ((n = e.getAttributeNode(t)) || e.getAttribute(t)) && !0 === e[t] ? t : n && n.specified ? n.value : null
                }, re.error = function(e) {
                    ...
                    var t, n = [],
                        r = 1,
                        i = 0;
                    if (l = !k.detectDuplicates, e.sort(c), l) {
                    ...
                    filter: {
                        ...
                        CLASS: function(e) {
                            var t = u[e + " "];
                            return t || (t = RegExp("(^|" + q + ")" + e + "(" + q + "|$)")) && u(e, function(e) {
                            ...
                            return 1 === h && 0 === g ? function(e) {
                                ...
                                if (c) {
                                    ...
                                    if (u = [y ? c.firstChild : c.lastChild], y && p) {
                                        for (s = (r = (i = c[b] || (c[b] = {}))[d] || [])[0] === E && r[1], a = r[0] === E && r[2], o = s && c.childNodes[s]; o = ++s && o && o[l] || (a = s = 0) || u.pop();)
                                            if (1 === o.nodeType && ++a && o === e) {
                                                i[d] = [E, s, a];
                                                break
                                            }
                                    } else if (p && (r = (e[b] || (e[b] = {}))[d]) && r[0] === E) a = r[1];
                                    else
                                        for (;
                                            (o = ++s && o && o[l] || (a = s = 0) || u.pop()) && ((v ? o.nodeName.toLowerCase() !== f : 1 !== o.nodeType) || !++a || (p && ((o[b] || (o[b] = {}))[d] = [E, a]), o !== e)););
                        ...
                        PSEUDO: function(e, o) {
                            ...
                            return a[b] ? a(o) : 1 < a.length ? (t = [e, e, "", o], w.setFilters.hasOwnProperty(e.toLowerCase()) ? te(function(e, t) {
                    ...
                    pseudos: {
                        not: te(function(e) {
                            var r = [],
                                i = [],
                                s = h(e.replace(B, "$1"));
                            return s[b] ? te(function(e, t, n, r) {
                        ...
                        lang: te(function(n) {
                            return $.test(n || "") || re.error("unsupported lang: " + n), n = n.replace(Q, K).toLowerCase(),
                                function(e) {
                                    var t;
                                    do {
            ...
            function ue(e, t) {
                ...
                for (a = e, s = [], u = w.preFilter; a;) {
                    for (o in n && !(r = P.exec(a)) || (r && (a = a.slice(r[0].length) || a), s.push(i = [])), n = !1, (r = R.exec(a)) && (n = r.shift(), i.push({
                            value: n,
                            type: r[0].replace(B, " ")
                        }), a = a.slice(n.length)), w.filter) !(r = I[o].exec(a)) || u[o] && !(r = u[o](r)) || (n = r.shift(), i.push({
                        value: n,
                        type: o,
                        matches: r
                    }), a = a.slice(n.length));
            ...
            function de(d, h, g, m, y, e) {
                return m && !m[b] && (m = de(m)), y && !y[b] && (y = de(y, e)), te(function(e, t, n, r) {
                    var i, o, a, s = [],
                        u = [],
                        l = t.length,
                        c = e || function(e, t, n) {
                        ...
                        p = g ? y || (e ? d : l || m) ? [] : t : f;
                    if (g && g(f, p, n, r), m)
                        for (i = pe(p, u), m(i, [], n, r), o = i.length; o--;)(a = i[o]) && (p[u[o]] = !(f[u[o]] = a));
                    if (e) {
                        if (y || d) {
                            if (y) {
            ...
            function he(e) {
                for (var r, t, n, i = e.length, o = w.relative[e[0].type], a = o || w.relative[" "], s = o ? 1 : 0, u = ce(function(e) {
                        return e === r
                    }, a, !0), l = ce(function(e) {
                        return -1 < H.call(r, e)
                    ...
                    if (t = w.relative[e[s].type]) c = [ce(fe(c), t)];
                        ...
                        if ((t = w.filter[e[s].type].apply(null, e[s].matches))[b]) {
            ...
            h = re.compile = function(e, t) {
                ...
                return o
            }, w.pseudos.nth = w.pseudos.eq, w.filters = me.prototype = w.pseudos, w.setFilters = new me, g(), re.attr = ye.attr, ye.find = re, ye.expr = re.selectors, ye.expr[":"] = ye.expr.pseudos, ye.unique = re.uniqueSort, ye.text = re.getText, ye.isXMLDoc = re.isXML, ye.contains = re.contains
        }(h);
    var ie = /Until$/,
    ...
    function ce(e, n, r) {
        ...
        if ("string" == typeof n) {
            ...
            if (ae.test(n)) return ye.filter(n, t, !r);
            n = ye.filter(n, t)
        }
    ...
    ye.fn.extend({
        ...
        is: function(e) {
            return !!e && ("string" == typeof e ? se.test(e) ? 0 <= ye(e, this.context).index(this[0]) : 0 < ye.filter(e, this).length : 0 < this.filter(e).length)
        },
        closest: function(e, t) {
            for (var n, r = 0, i = this.length, o = [], a = se.test(e) || "string" != typeof e ? ye(e, t || this.context) : 0; r < i; r++)
        ...
        ye.fn[r] = function(e, t) {
            ...
            return ie.test(r) || (t = e), t && "string" == typeof t && (n = ye.filter(t, n)), n = 1 < this.length && !ue[r] ? ye.unique(n) : n, 1 < this.length && oe.test(r) && (n = n.reverse()), this.pushStack(n)
        }
    }), ye.extend({
    ...
    function Me(e, t) {
        ...
        if (!o)
            for (o = [], n = e.childNodes || e; null != (r = n[i]); i++) !t || ye.nodeName(r, t) ? o.push(r) : ye.merge(o, Me(r, t));
    ...
    Se.optgroup = Se.option, Se.tbody = Se.tfoot = Se.colgroup = Se.caption = Se.thead, Se.th = Se.td, ye.fn.extend({
        text: function(e) {
            return ye.access(this, function(e) {
                return e === N ? ye.text(this) : this.empty().append((this[0] && this[0].ownerDocument || g).createTextNode(e))
        ...
        remove: function(e, t) {
            for (var n, r = 0; null != (n = this[r]); r++)(!e || 0 < ye.filter(e, [n]).length) && (t || 1 !== n.nodeType || ye.cleanData(Me(n)), n.parentNode && (t && ye.contains(n.ownerDocument, n) && Le(Me(n, "script")), n.parentNode.removeChild(n)));
            return this
        },
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++) {
                for (1 === e.nodeType && ye.cleanData(Me(e, !1)); e.firstChild;) e.removeChild(e.firstChild);
        ...
        html: function(e) {
            return ye.access(this, function(e) {
                ...
                if (!("string" != typeof e || Te.test(e) || !ye.support.htmlSerialize && he.test(e) || !ye.support.leadingWhitespace && ge.test(e) || Se[(ve.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(me, "<$1></$2>");
                    try {
                        for (; n < r; n++) 1 === (t = this[n] || {}).nodeType && (ye.cleanData(Me(t, !1)), t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
        ...
        domManip: function(n, r, i) {
            ...
            var e, t, o, a, s, u, l, c, f = 0,
                ...
                g = n[0],
                m = ye.isFunction(g);
            if (m || !(p <= 1 || "string" != typeof g || ye.support.checkClone) && Ne.test(g)) return this.each(function(e) {
                var t = d.eq(e);
            ...
            if (p && (e = (u = ye.buildFragment(n, this[0].ownerDocument, !1, this)).firstChild, 1 === u.childNodes.length && (u = e), e)) {
                for (r = r && ye.nodeName(e, "tr"), o = (a = ye.map(Me(u, "script"), je)).length; f < p; f++) t = u, f !== h && (t = ye.clone(t, !0, !0), o && ye.merge(a, Me(t, "script"))), i.call(r && ye.nodeName(this[f], "table") ? (l = this[f], c = "tbody", l.getElementsByTagName(c)[0] || l.appendChild(l.ownerDocument.createElement(c))) : this[f], t, f);
                if (o)
                    for (s = a[a.length - 1].ownerDocument, ye.map(a, De), f = 0; f < o; f++) t = a[f], Ce.test(t.type || "") && !ye._data(t, "globalEval") && ye.contains(s, t) && (t.src ? ye.ajax({
                        url: t.src,
                        type: "GET",
                        dataType: "script",
                        async: !1,
                        global: !1,
                        throws: !0
                    }) : ye.globalEval((t.text || t.textContent || t.innerHTML || "").replace(Ee, "")));
                u = e = null
            }
            return this
        }
        ...
        ye.fn[e] = function(e) {
            for (var t, n = 0, r = [], i = ye(e), o = i.length - 1; n <= o; n++) t = n === o ? this : this.clone(!0), ye(i[n])[a](t), l.apply(r, t.get());
            return this.pushStack(r)
        }
    }), ye.extend({
        clone: function(e, t, n) {
            var r, i, o, a, s, u = ye.contains(e.ownerDocument, e);
            if (ye.support.html5Clone || ye.isXMLDoc(e) || !he.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Ae.innerHTML = e.outerHTML, Ae.removeChild(o = Ae.firstChild)), !(ye.support.noCloneEvent && ye.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ye.isXMLDoc(e)))
        ...
        buildFragment: function(e, t, n, r) {
            for (var i, o, a, s, u, l, c, f = e.length, p = fe(t), d = [], h = 0; h < f; h++)
                ...
                for (s = s || p.appendChild(t.createElement("div")), u = (ve.exec(o) || ["", ""])[1].toLowerCase(), c = Se[u] || Se._default, s.innerHTML = c[1] + o.replace(me, "<$1></$2>") + c[2], i = c[0]; i--;) s = s.lastChild;
                if (!ye.support.leadingWhitespace && ge.test(o) && d.push(t.createTextNode(ge.exec(o)[0])), !ye.support.tbody)
                    for (i = (o = "table" !== u || be.test(o) ? "<table>" !== c[1] || be.test(o) ? 0 : s : s.firstChild) && o.childNodes.length; i--;) ye.nodeName(l = o.childNodes[i], "tbody") && !l.childNodes.length && o.removeChild(l);
                for (ye.merge(d, s.childNodes), s.textContent = ""; s.firstChild;) s.removeChild(s.firstChild);
                s = p.lastChild
            } else d.push(t.createTextNode(o));
            for (s && p.removeChild(s), ye.support.appendChecked || ye.grep(Me(d, "input"), _e), h = 0; o = d[h++];)
                if ((!r || -1 === ye.inArray(o, r)) && (a = ye.contains(o.ownerDocument, o), s = Me(p.appendChild(o), "script"), a && Le(s), n))
    ...
    function et(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; a < s; a++)(r = e[a]).style && (o[a] = ye._data(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && Ze(r) && (o[a] = ye._data(r, "olddisplay", it(r.nodeName)))) : o[a] || (i = Ze(r), (n && "none" !== n || !i) && ye._data(r, "olddisplay", i ? n : ye.css(r, "display"))));
    ...
    function nt(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; o < 4; o += 2) "margin" === n && (a += ye.css(e, n + Ge[o], !0, i)), r ? ("content" === n && (a -= ye.css(e, "padding" + Ge[o], !0, i)), "margin" !== n && (a -= ye.css(e, "border" + Ge[o] + "Width", !0, i))) : (a += ye.css(e, "padding" + Ge[o], !0, i), "padding" !== n && (a += ye.css(e, "border" + Ge[o] + "Width", !0, i)));
        return a
    }
    ...
    function it(e) {
        var t = g,
            n = Ve[e];
        return n || ("none" !== (n = ot(e, t)) && n || ((t = ((Fe = (Fe || ye("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement))[0].contentWindow || Fe[0].contentDocument).document).write("<!doctype html><html><body>"), t.close(), n = ot(e, t), Fe.detach()), Ve[e] = n), n
    }
    ...
    ye.fn.extend({
        css: function(e, t) {
            return ye.access(this, function(e, t, n) {
                var r, i, o = {},
                    a = 0;
                if (ye.isArray(t)) {
                    for (i = Oe(e), r = t.length; a < r; a++) o[t[a]] = ye.css(e, t[a], !1, i);
                    return o
                }
        ...
        toggle: function(e) {
            ...
            return this.each(function() {
                (t ? e : Ze(this)) ? ye(this).show(): ye(this).hide()
            })
        }
    }), ye.extend({
        cssHooks: {
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = ye.camelCase(t),
                    u = e.style;
                if (t = ye.cssProps[s] || (ye.cssProps[s] = Ke(u, s)), a = ye.cssHooks[t] || ye.cssHooks[s], n === N) return a && "get" in a && (i = a.get(e, !1, r)) !== N ? i : u[t];
                if ("string" === (o = typeof n) && (i = Ue.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(ye.css(e, t)), o = "number"), !(null == n || "number" === o && isNaN(n) || ("number" !== o || ye.cssNumber[s] || (n += "px"), ye.support.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), a && "set" in a && (n = a.set(e, n, r)) === N))) try {
                    u[t] = n
                } catch (e) {}
            }
        },
        css: function(e, t, n, r) {
            var i, o, a, s = ye.camelCase(t);
            return t = ye.cssProps[s] || (ye.cssProps[s] = Ke(e.style, s)), (a = ye.cssHooks[t] || ye.cssHooks[s]) && "get" in a && (o = a.get(e, !0, n)), o === N && (o = Be(e, t, r)), "normal" === o && t in Je && (o = Je[t]), "" === n || n ? (i = parseFloat(o), !0 === n || ye.isNumeric(i) ? i || 0 : o) : o
        },
        ...
        var r, i, o, a = n || Oe(e),
            ...
            u = e.style;
        return a && ("" !== s || ye.contains(e.ownerDocument, e) || (s = ye.style(e, t)), Xe.test(s) && Ie.test(t) && (r = u.width, i = u.minWidth, o = u.maxWidth, u.minWidth = u.maxWidth = u.width = s, s = a.width, u.width = r, u.minWidth = i, u.maxWidth = o)), s
        ...
        var r, i, o, a = n || Oe(e),
            s = a ? a[t] : N,
            u = e.style;
        return null == s && u && u[t] && (s = u[t]), Xe.test(s) && !We.test(t) && (r = u.left, (o = (i = e.runtimeStyle) && i.left) && (i.left = e.currentStyle.left), u.left = "fontSize" === t ? "1em" : s, s = u.pixelLeft + "px", u.left = r, o && (i.left = o)), "" === s ? "auto" : s
    }), ye.each(["height", "width"], function(e, i) {
        ye.cssHooks[i] = {
            get: function(e, t, n) {
                return t ? 0 === e.offsetWidth && $e.test(ye.css(e, "display")) ? ye.swap(e, Ye, function() {
                    return rt(e, i, n)
                }) : rt(e, i, n) : N
            },
            set: function(e, t, n) {
                var r = n && Oe(e);
                return tt(0, t, n ? nt(e, i, n, ye.support.boxSizing && "border-box" === ye.css(e, "boxSizing", !1, r), r) : 0)
            }
        }
        ...
        set: function(e, t) {
            ...
            ((n.zoom = 1) <= t || "" === t) && "" === ye.trim(o.replace(Pe, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === t || r && !r.filter) || (n.filter = Pe.test(o) ? o.replace(Pe, i) : o + " " + i)
        }
    }), ye(function() {
        ye.support.reliableMarginRight || (ye.cssHooks.marginRight = {
            ...
            ye.cssHooks[n] = {
                get: function(e, t) {
                    return t ? (t = Be(e, n), Xe.test(t) ? ye(e).position()[n] + "px" : t) : N
                }
            }
        })
        ...
        }, Ie.test(i) || (ye.cssHooks[i + o].set = tt)
    });
    var at = /%20/g,
        st = /\[\]$/,
        ut = /\r?\n/g,
    ...
    ye.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !ye(this).is(":disabled") && ct.test(this.nodeName) && !lt.test(e) && (this.checked || !we.test(e))
            }).map(function(e, t) {
                var n = ye(this).val();
    ...
    function St(t, i, o, a) {
        ...
        function l(e) {
            var r;
            return s[e] = !0, ye.each(t[e] || [], function(e, t) {
                var n = t(i, o, a);
    ...
    pt = Tt.exec(dt.toLowerCase()) || [], ye.fn.load = function(e, t, n) {
        ...
        ajaxSetup: function(e, t) {
            return t ? At(At(e, ye.ajaxSettings), t) : At(ye.ajaxSettings, e)
        },
        ajaxPrefilter: Et(Nt),
        ajaxTransport: Et(Ct),
        ajax: function(e, t) {
            "object" == typeof e && (t = e, e = N), t = t || {};
            var n, r, c, f, p, d, h, i, g = ye.ajaxSetup({}, t),
                m = g.context || g,
            ...
            if (v.promise(w).complete = b.add, w.success = w.done, w.error = w.fail, g.url = ((e || g.url || dt) + "").replace(mt, "").replace(xt, pt[1] + "//"), g.type = t.method || t.type || g.method || g.type, g.dataTypes = ye.trim(g.dataType || "*").toLowerCase().match(C) || [""], null == g.crossDomain && (n = Tt.exec(g.url.toLowerCase()), g.crossDomain = !(!n || n[1] === pt[1] && n[2] === pt[2] && (n[3] || ("http:" === n[1] ? 80 : 443)) == (pt[3] || ("http:" === pt[1] ? 80 : 443)))), g.data && g.processData && "string" != typeof g.data && (g.data = ye.param(g.data, g.traditional)), St(Nt, g, t, w), 2 === T) return w;
            for (r in (d = g.global) && 0 == ye.active++ && ye.event.trigger("ajaxStart"), g.type = g.type.toUpperCase(), g.hasContent = !bt.test(g.type), c = g.url, g.hasContent || (g.data && (c = g.url += (gt.test(c) ? "&" : "?") + g.data, delete g.data), !1 === g.cache && (g.url = yt.test(c) ? c.replace(yt, "$1_=" + ht++) : c + (gt.test(c) ? "&" : "?") + "_=" + ht++)), g.ifModified && (ye.lastModified[c] && w.setRequestHeader("If-Modified-Since", ye.lastModified[c]), ye.etag[c] && w.setRequestHeader("If-None-Match", ye.etag[c])), (g.data && g.hasContent && !1 !== g.contentType || t.contentType) && w.setRequestHeader("Content-Type", g.contentType), w.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + kt + "; q=0.01" : "") : g.accepts["*"]), g.headers) w.setRequestHeader(r, g.headers[r]);
            ...
            function u(e, t, n, r) {
                var i, o, a, s, u, l = t;
                2 !== T && (T = 2, p && clearTimeout(p), h = N, f = r || "", w.readyState = 0 < e ? 4 : 0, n && (s = function(e, t, n) {
                ...
                }(g, w, n)), 200 <= e && e < 300 || 304 === e ? (g.ifModified && ((u = w.getResponseHeader("Last-Modified")) && (ye.lastModified[c] = u), (u = w.getResponseHeader("etag")) && (ye.etag[c] = u)), 204 === e ? (i = !0, l = "nocontent") : 304 === e ? (i = !0, l = "notmodified") : (l = (i = function(e, t) {
                    var n, r, i, o, a = {},
                        s = 0,
                        u = e.dataTypes.slice(),
                        l = u[0];
                ...
                }(g, s)).state, o = i.data, i = !(a = i.error))) : (a = l, !e && l || (l = "error", e < 0 && (e = 0))), w.status = e, w.statusText = (t || l) + "", i ? v.resolveWith(m, [o, l, w]) : v.rejectWith(m, [w, l, a]), w.statusCode(x), x = N, d && y.trigger(i ? "ajaxSuccess" : "ajaxError", [w, g, i ? o : a]), b.fireWith(m, [w, l]), d && (y.trigger("ajaxComplete", [w, g]), --ye.active || ye.event.trigger("ajaxStop")))
            }
            return w
        },
        ...
        if (t.crossDomain) {
            var r, i = g.head || ye("head")[0] || g.documentElement;
            return {
                send: function(e, n) {
    ...
    ye.ajaxSetup({
        ...
        return a || "jsonp" === e.dataTypes[0] ? (r = e.jsonpCallback = ye.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Dt, "$1" + r) : !1 !== e.jsonp && (e.url += (gt.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function() {
            return o || ye.error(r + " was not called"), o[0]
        }, e.dataTypes[0] = "json", i = h[r], h[r] = function() {
            o = arguments
        }, n.always(function() {
            h[r] = i, e[r] && (e.jsonpCallback = t.jsonpCallback, jt.push(r)), o && ye.isFunction(i) && i(o[0]), o = i = N
        }), "script") : N
    });
    var Lt, Ht, qt = 0,
    ...
    } : _t, Ht = ye.ajaxSettings.xhr(), ye.support.cors = !!Ht && "withCredentials" in Ht, (Ht = ye.support.ajax = !!Ht) && ye.ajaxTransport(function(l) {
        var c;
                ...
                u.send(l.hasContent && l.data || null), c = function(e, t) {
                    ...
                    try {
                        if (c && (t || 4 === u.readyState))
                            if (c = N, s && (u.onreadystatechange = ye.noop, Mt && delete Lt[s]), t) 4 !== u.readyState && u.abort();
                            else {
                    ...
                    o && a(n, i, o, r)
                }, l.async ? 4 === u.readyState ? setTimeout(c) : (s = ++qt, Mt && (Lt || (Lt = {}, ye(h).unload(Mt)), Lt[s] = c), u.onreadystatechange = c) : c()
            },
            abort: function() {
                c && c(N, !0)
            }
    ...
    var Ft, Ot, Bt = /^(?:toggle|show|hide)$/,
        ...
        Wt = [function(t, e, n) {
            ...
            for (i in n.queue || (null == (c = ye._queueHooks(t, "fx")).unqueued && (c.unqueued = 0, f = c.empty.fire, c.empty.fire = function() {
                ...
                })), 1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [d.overflow, d.overflowX, d.overflowY], "inline" === ye.css(t, "display") && "none" === ye.css(t, "float") && (ye.support.inlineBlockNeedsLayout && "inline" !== it(t.nodeName) ? d.zoom = 1 : d.display = "inline-block")), n.overflow && (d.overflow = "hidden", ye.support.shrinkWrapBlocks || p.always(function() {
    ...
    ye.Animation = ye.extend(zt, {
        tweener: function(e, t) {
            for (var n, r = 0, i = (e = ye.isFunction(e) ? (t = e, ["*"]) : e.split(" ")).length; r < i; r++) n = e[r], $t[n] = $t[n] || [], $t[n].unshift(t)
        },
        prefilter: function(e, t) {
            t ? Wt.unshift(e) : Wt.push(e)
        }
    }), ((ye.Tween = Xt).prototype = {
        constructor: Xt,
        ...
        run: function(e) {
            ...
            return this.pos = t = this.options.duration ? ye.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : Xt.propHooks._default.set(this), this
        }
    ...
    }, ye.timers = [], ye.fx = Xt.prototype.init, ye.fx.tick = function() {
        var e, t = ye.timers,
            n = 0;
        for (Ft = ye.now(); t.length > n; n++)(e = t[n])() || t[n] !== e || t.splice(n--, 1);
        t.length || ye.fx.stop(), Ft = N
    }, ye.fx.timer = function(e) {
        e() && ye.timers.push(e) && ye.fx.start()
    }, ye.fx.interval = 13, ye.fx.start = function() {
        Ot = Ot || setInterval(ye.fx.tick, ye.fx.interval)
    }, ye.fx.stop = function() {
        ...
        var e, n, r = {
            ...
            i = this[0],
            o = i && i.ownerDocument;
        return o ? (e = o.documentElement, ye.contains(e, i) ? (typeof i.getBoundingClientRect !== y && (r = i.getBoundingClientRect()), n = Vt(o), {
        ...
        setOffset: function(e, t, n) {
            ...
            var i, o, a = ye(e),
                ...
                c = {},
                f = {};
            o = ("absolute" === r || "fixed" === r) && -1 < ye.inArray("auto", [u, l]) ? (i = (f = a.position()).top, f.left) : (i = parseFloat(u) || 0, parseFloat(l) || 0), ye.isFunction(t) && (t = t.call(e, n, s)), null != t.top && (c.top = t.top - s.top + i), null != t.left && (c.left = t.left - s.left + o), "using" in t ? t.using.call(e, c) : a.css(c)
        }
    }, ye.fn.extend({
        position: function() {
            if (this[0]) {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var e = this.offsetParent || g.documentElement; e && !ye.nodeName(e, "html") && "static" === ye.css(e, "position");) e = e.offsetParent;
